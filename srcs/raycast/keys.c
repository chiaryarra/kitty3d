...
/*   Updated: 2025/07/22 21:17:14 by lbarreto         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	move_front_back(t_data *data, int direction)
{
	...
	if (can_move_front_back(data, data->raycast->temp_x, \
