...
/*   Updated: 2025/07/14 15:57:23 by lbarreto         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void cast_rays(t_data *d)
{
    ...
    while (x < SCREEN_WIDTH)
    {
        ...
        while (y < draw_start)
        {
            put_pixel(d->raycast, x, y, d->map->ceiling_color);
            y++;
        }
        y = draw_end;
        while (y < SCREEN_HEIGHT)
        {
            put_pixel(d->raycast, x, y, d->map->floor_color);
            y++;
        }
        x++;
    }
